              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="form-group mb-3">
                            <label for="nik" class='mb-2'>Nama</label>
                            <input type="text" class="form-control" id="nik" placeholder="contoh : 'Supervisor' ">
                        </div>
        
                        <div class="form-group mb-3">
                          <label for="nama" class='mb-2'>Keterangan</label>
                          <textarea name="keterangan" id=""rows="10" class="form-control" placeholder="contoh : 'Jabatan Supervisor' "></textarea>
                        </div>
                    </form>
